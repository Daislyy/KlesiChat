...
export default function IncomingCallOverlay() {
  ...
  const displayUser = callStatus === "incoming" ? incomingCaller : activeOtherUser;
          ...
          <div>
            ...
            <p
              style={{
                margin: "6px 0 0 0",
                fontSize: 14,
                color: callStatus === "connected" ? "#22c55e" : "#9ca3af",
              ...
              <>
                <button
                  ...
                  style={{
                    ...
                    background: isMuted ? "#ef4444" : "#282836",
                    color: isMuted ? "#fff" : "#e2e8f0",
                    cursor: "pointer",
                    display: "flex", alignItems: "center", justifyContent: "center",
